System.register(['angular2/core', 'angular2/http', '../blocks/blocks', '../shared/shared'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            carsUrl = shared_1.CONFIG.baseUrls.cars;
            CarService = (function () {
                function CarService(_http, _exceptionService, _messageService, _spinnerService) {
                    var _this = this;
                    this._http = _http;
                    ...
                    this._messageService.state.subscribe(function (state) { return _this.getCars(); });
                }
