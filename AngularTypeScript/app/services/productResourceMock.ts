...
module app.common {
    ...
    function mockRun($httpBackend: ng.IHttpBackendService): void {
        ...
        var product: app.domain.Product;
        ...
        product = new app.domain.Product(5, "Video Game SlugCheckController", "GMG-0042", new Date(2012, 9, 25), 35.95,
        ...
        $httpBackend.whenGET(editingRegex).respond((method, url, data) => {
        ...
        // Catch all for testing purpose
        $httpBackend.whenGET(/api/).respond((method, url, data) => {
            return [200, products, {}];
        });
