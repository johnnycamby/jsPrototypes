    ...
    var
        ...
        monthsAbbrev = (function(months){
            var
                ...
                get = function(){
                    if(result === null){
                        result = _.map(months, function(value){ // map months and get the first 3 xters of a month
                            return {
        ...
        aggregations = {
            ...
            monthlySalesSummary : function(){
                var
                    ...
                    monthlySummaries = _.map(totalSales, function(value){
                        var result;

                        result = (value / 10000); //round off
