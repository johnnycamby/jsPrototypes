...
function getLogFormat() { 
    ...
    // make sure you have a valid format
    ...
    if (_.has(options, 'stream')) {
        ...
        try {
            ...
            if (process.env.NODE_ENV !== 'test') {
                ...
                console.log();
                console.log(chalk.maroon('An error has occured during the creation of the WriteStream. The stream option has been omitted.'));
                console.log(chalk.maroon(err));
                console.log();
            }
        }
    }
