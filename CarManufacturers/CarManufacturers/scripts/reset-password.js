...
mg.connect(function(db) {
    ...
    User.find().exec(function(err, users) {
        ...
        function sendEmail(user) {
            ...
            transporter.sendEmail(email, emailCallback(user));
        }
        ...
        function reportAndExit(processCount, errorCount) {
            ...
            if (processedCount === 0) {
                ...
                console.log('Sent ' +successCount + ' of' + processedCount + ' emails successfully');
            }
