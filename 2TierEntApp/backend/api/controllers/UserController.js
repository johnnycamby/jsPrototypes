...
var request = require('request'); // for talking with Twitter-server endpoint(s)
var jwt = require('jwt-simple'); // for token encoding and decoding
var moment = require('moment'); // for working with time say add 14 days to the current time, so that out token expire after that time
var config = require('../services/config.js');

module.exports = {

    // All functions a Node/Express middle-ware
