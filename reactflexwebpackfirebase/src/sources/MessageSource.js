...
let MessageSource = {
            ...
            return new Promise((resolve, reject) => {
                ...
                firebaseRef.push({
                   ...
                   // "author": state.user.google.displayName,
                    "author": state.user.facebook.displayName,
                    "userId": state.user.uid,
                   // "profilePic": state.user.google.profileImageURL
                    "profilePic": state.user.facebook.profileImageURL
    ...
    getMessages: {
        remote(state){
            ...
            firebaseRef = new Firebase('https://rfwfapp.firebaseio.com/messages/' + state.selectedChannel.key);
