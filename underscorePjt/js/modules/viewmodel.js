 ...
 var vm = {
    ...
    init: function(){
        ...
        _.each(monthlySummary, function(summary){
            summary.className = (summary.value > data.planTarget) ? 'above-plan' : '';
        });
    ...
    renderProperties : function(properties){
        ...
        var markup = renderer.renderCollection(properties, this.propertiesRenderer);
    ...
    processElements : function(){
        ...
        $('#send-to-marketing-button').click(this.sentToMarketing());
